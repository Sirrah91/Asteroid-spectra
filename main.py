...
def pipeline(n_models: int = 5) -> Union[np.ndarray, None]:
    ...
    if train_new_model:
        ...
        """ 
        # these models are for full range
        model_names = ['20211008111913_FC.h5',
                       '20211008112840_FC.h5',
                       '20211008114103_FC.h5']
        """

        # these models are for Tuomas range
        model_names = ['20210916142934_FC_Tuomas.h5',
                       '20210916143820_FC_Tuomas.h5',
                       '20210916144710_FC_Tuomas.h5',
                       '20210916145531_FC_Tuomas.h5',
                       '20210916150307_FC_Tuomas.h5']
