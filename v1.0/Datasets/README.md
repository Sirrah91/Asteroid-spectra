...
- combined-denoised-norm.dat
  ...
  - relevant metadata and mineral and chemical analyses are listed in table **Sample_Catalogue.xlsx**
  - relevant metadata, mineral and chemical analyses, and reflectance spectra of the sample which pass through the selection criteria of the final model is in **Sample_Catalogue_Clean.xlsx**
