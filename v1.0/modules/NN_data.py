...
def load_data(filename_data: str, clean_dataset: bool = False, keep_all_labels: bool = False,
    ...
    if reinterpolation:
        x_train = reinterpolate_data(x_train, to_what_data=interpolate_to, wvl_grid=new_wvl_grid)
...
def reinterpolate_data(x_data: np.ndarray, wvl_grid: np.ndarray = None, to_what_data: str = None) -> np.ndarray:
