...
val_portion = 0.  # Set the fraction of data for validation
test_portion = 0.  # Set the fraction of data for tests
...
model_subdir = "taxonomy"  # directory where to save models
