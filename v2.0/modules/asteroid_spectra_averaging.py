...
lon_grid, lat_grid = safe_arange(0., 360., dlon, endpoint=True), safe_arange(-90., 90., dlat, endpoint=True)
...
def preprocess_lon(asteroid_name: str, coord_vector: np.ndarray) -> tuple[float, ...]:
    ...
    if asteroid_name == "Itokawa":
        ...
        ### !!! TADY SE OBCAS DEJE NECO PODIVNEHO S LON (OD 359.9 DO 360. A PODOBNE...)
        ### !!! DOPLNIT NEJAKOU PODMINKU NA DELTA LON + LON OKOLO 360 NEBO OKOLO 0 A PAK DELTA LON = 360
