    ...
    if "composition" in composition_or_taxonomy:
        ...
        if grid_option == f"450{_sep_in}2450{_sep_in}5{_sep_in}550":
            ...
            p = {
                ...
                "num_nodes": [12],  # Number of nodes in hidden layers / number of filters for CNN
                "kern_size": 3,  # Width of the kernel (only if CNN)
                "kern_pad": "same",  # Kernel padding (CNN only)
                "input_activation": "relu",  # Activation function of input layer
                "output_activation": "softmax",  # Activation function of output layer (relu, softmax, sigmoid)
                "dropout_input_hidden": 0.0,  # Dropout
        ...
        if grid_option == f"450{_sep_in}2450{_sep_in}5{_sep_in}550":
            ...
            p = {
                ...
                "kern_size": 5,  # Width of the kernel (only if CNN)
                "kern_pad": "same",  # Kernel padding (CNN only)
                "input_activation": "tanh",  # Activation function of input layer
                "output_activation": "softmax",  # Activation function of output layer
                "dropout_input_hidden": 0.15,  # Dropout
                "dropout_hidden_hidden": 0.0,  # Dropout
                "dropout_hidden_output": 0.2,  # Dropout
